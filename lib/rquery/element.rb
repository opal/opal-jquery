...
class Element < Array; end

require 'rquery/element/sizzle'
require 'rquery/element/css'
require 'rquery/element/dom_events'
...
class Element
  ...
  # Access the previous element context
  ...
  # Removes all children from each element in the receiver.
  def clear
    `var elem, child;
